...
if __name__ == "__main__":
    ...
    print("===> Total {} Frames ==> AVG EPE Error: {:.4f}, AVG Error Rate: {:.4f}, img_size: {}x{} ".format(len(filelist), avg_error, avg_rate, opt.crop_width, opt.crop_height) + " " + opt.resume, file = testresult) 
    testresult.close()