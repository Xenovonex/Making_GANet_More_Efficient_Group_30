...
parser.add_argument('--saveimages', type=bool, default=False, help="save images or not")
...
if __name__ == "__main__":
    ...
    evalresult = open('evalresult.txt', 'a+') 
    print("===> Total {} Frames ==> AVG EPE Error: {:.4f}, AVG Error Rate: {:.4f}, img_size: {}x{} ".format(len(filelist), avg_error, avg_rate, opt.crop_width, opt.crop_height) + " " + opt.resume + "\n", file = evalresult) 
    evalresult.close()